...
class InfoDialog extends StatelessWidget {
  const InfoDialog({super.key, required this.title, required this.descriptions, required this.text, this.img});
  ...
  Widget build(BuildContext context) {
    return CustomDialog(child: _buildContentBox(context));
  }
        ...
        img != null
            ? Positioned(
                ...
                child: CircleAvatar(
                  ...
                  child:
                      ClipRRect(borderRadius: const BorderRadius.all(Radius.circular(Dimens.avatarRadius)), child: img),
                ),
              )
            : const SizedBox(),
      ],

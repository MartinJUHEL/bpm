...
import '../../publish_ad/domain/usecases/pick_photos_from_gallery_use_case.dart'
    as _i17;
import '../../publish_ad/domain/usecases/remove_photo_use_case.dart' as _i19;
import '../../publish_ad/domain/usecases/upload_photo_use_case.dart' as _i21;
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.factory<_i19.RemovePhotosUseCase>(
      () => _i19.RemovePhotosUseCase(gh<_i8.FirebaseStorage>()));
  await gh.factoryAsync<_i20.SharedPreferences>(
    () => appModule.prefs,
    preResolve: true,
  );
  gh.factory<_i21.UploadPhotosUseCase>(
      () => _i21.UploadPhotosUseCase(gh<_i8.FirebaseStorage>()));

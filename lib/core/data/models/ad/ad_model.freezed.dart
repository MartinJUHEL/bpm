...
class _$AdEntityImpl extends _AdEntity {
  ...
  @override
  String toString() {
    return 'AdModel(title: $title, description: $description, price: $price, adType: $adType, photosUrl: $photosUrl, city: $city, renterId: $renterId, renterName: $renterName, renterPhotoUrl: $renterPhotoUrl, creationDate: $creationDate)';
  }

...
class _$LatLongImpl implements _LatLong {
  const _$LatLongImpl({required this.lat, required this.long});
...
abstract class _LatLong implements LatLong {
  const factory _LatLong(
      {required final double lat, required final double long}) = _$LatLongImpl;

...
class _$AdEntityImpl implements _AdEntity {
  ...
  @override
  String toString() {
    return 'AdEntity(title: $title, description: $description, price: $price, adType: $adType, photosUrl: $photosUrl, city: $city, renterId: $renterId, renterName: $renterName, renterPhotoUrl: $renterPhotoUrl, creationDate: $creationDate)';
  }
